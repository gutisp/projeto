...
?>
<?php
// recebi os valores da pagina cadas.php e coloca nas vairaveis de php q são as q começa com $
$nome = $_REQUEST['nome'];
...
$obs = $_REQUEST['obs'];
// inseri os dados no banco de dados da tabela aluno
...
// inseri os dados no banco de dados da tabela matricula
